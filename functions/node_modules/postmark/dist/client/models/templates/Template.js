...
var UpdateTemplateRequest = /** @class */ (function () {
    function UpdateTemplateRequest(Name, Subject, HtmlBody, TextBody, Alias) {
        this.Name = Name;
...
var CreateTemplateRequest = /** @class */ (function (_super) {
    ...
    function CreateTemplateRequest(Name, Subject, HtmlBody, TextBody, Alias) {
        return _super.call(this, Name, Subject, HtmlBody, TextBody, Alias) || this;
    }
    return CreateTemplateRequest;
}(UpdateTemplateRequest));
exports.CreateTemplateRequest = CreateTemplateRequest;
var TemplateValidationOptions = /** @class */ (function () {
    function TemplateValidationOptions(Subject, HtmlBody, TextBody, TestRenderModel) {
        this.Subject = Subject;
        this.HtmlBody = HtmlBody;
        this.TextBody = TextBody;
